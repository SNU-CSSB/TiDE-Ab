...
def to_atom14(trans, rots):
    num_batch, num_res, _ = trans.shape
    final_atom14 = compute_backbone(du.create_rigid(rots, trans), torch.zeros(num_batch, num_res, 2, device=trans.device))[-1]
    return final_atom14
...
def frames_to_atom14_pos(r: Rigid, aatype: torch.Tensor,):
